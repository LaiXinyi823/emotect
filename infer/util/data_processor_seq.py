...
class BaseReader:
    ...
    def file_based_convert_examples_to_features(self, input_file, output_file):
        ...
        for _, example in enumerate(examples):
            ...
            file_name = "emotect" + "_" + str(example_count) + ".bin"
            ...
            np.array(record.segment_ids, dtype=np.int32).tofile(token_file_path)
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="text.tsv", help="the format of infer file is tsv.")
